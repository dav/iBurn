...
@synthesize id, name, year, description, url, contactEmail, contactEmail, hometown, location, circularStreet, timeAddress, latitude, longitude;

DECLARE_PROPERTIES(
	DECLARE_PROPERTY(@"id", @"@\"NSNumber\""),
