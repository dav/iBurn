...
@interface FavoritesTableCell(Private_Methods)
...
- (id)initWithFrame:(CGRect)frame reuseIdentifier:(NSString *)reuseIdentifier {
	...
	if (self = [super initWithFrame:frame reuseIdentifier:reuseIdentifier]) {
		...
		[mNameStatusView setImage:[UIImage imageNamed:@"Favorites.png"]];
		*/
...
//Initalise the UI elements with appropriate values from the passed in FavoritesInstall object
- (void) setFavoritesInfo:(Favorite *)inFavorites
{		
	//Assign appropriate values to the UI elements
	/*
	[mNameTitleField setText:[inFav objectForKey: @"name"]];
	[mNameDescriptionField setText:[inFav objectForKey: @""]];
	 */
