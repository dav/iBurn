...
@interface CampTableCell(Private_Methods)
	-(void)layoutViewsInRect:(CGRect)frame;
@end

@implementation CampTableCell
...
- (id)initWithFrame:(CGRect)frame reuseIdentifier:(NSString *)reuseIdentifier {
	...
	if (self = [super initWithFrame:frame reuseIdentifier:reuseIdentifier]) {
		...
		mNameTitleField.font = [UIFont systemFontOfSize:18.0];
		...
		[mNameStatusView setImage:[UIImage imageNamed:@"camps.png"]];
...
{
	CGRect msgTitleRect       = { 10,   2, 250, NAME_TITLE_FIELD_HEIGHT};
	CGRect msgDescriptionRect = { 10,   27, 250, NAME_DESC_FIELD_HEIGHT};
...
//Initalise the UI elements with appropriate values from the passed in Camp object
- (void) setCampInfo:(ThemeCamp *)inCamp
{		
	//Assign appropriate values to the UI elements
	[mNameTitleField setText:[inCamp objectForKey: @"name"]];
	[mNameDescriptionField setText:[inCamp objectForKey: @"location"]];
	latitude = [inCamp objectForKey: @"latitude"];
	longitude = [inCamp objectForKey: @"longitude"];
	if(latitude != NULL && longitude != NULL) {
